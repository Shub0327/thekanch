...
export default function About() {
  ...
  return (
    <div className="page-fade-in bg-canvas text-left">
      ...
      <section className="relative py-12 md:py-[100px] bg-secondary border-b border-sandstone/25">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[80px]">
          <span className="label-caps mb-3 block text-primary">Our Legacy</span>
          <h2 className="font-serif text-3xl md:text-6xl text-dark-surface max-w-2xl font-normal leading-[1.1] mb-4 md:mb-6">
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[80px] py-16 md:py-[120px] grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
      ...
      <section id="craftsmanship" className="bg-secondary border-y border-sandstone/25 py-16 md:py-[120px]">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-[80px]">
